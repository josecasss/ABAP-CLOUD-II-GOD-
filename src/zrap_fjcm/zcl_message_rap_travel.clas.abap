CLASS zcl_message_rap_travel DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZCM_FLIGHT_FJCM',

      BEGIN OF customer_unkown,
        msgid TYPE symsgid VALUE 'ZCM_FLIGHT_FJCM',     "Message Class
        msgno TYPE symsgno VALUE '001',                 "Message Number
        attr1 TYPE scx_attrname VALUE 'MV_CUSTOMER_ID', "Attribute 1
      ...
      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE 'ZCM_FLIGHT_FJCM',
    ...
    METHODS constructor
      IMPORTING
        ...
        severity              TYPE if_abap_behv_message=>t_severity OPTIONAL "Color si es un error, warning, info
...
CLASS ZCL_MESSAGE_RAP_TRAVEL IMPLEMENTATION.
