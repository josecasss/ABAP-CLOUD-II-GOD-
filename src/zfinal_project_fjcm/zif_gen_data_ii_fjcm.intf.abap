interface zif_gen_data_ii_fjcm
  public.

  " Table Types for CATALOG
  types: tt_priority type standard table of zdt_priority_fjc,
         tt_status   type standard table of zdt_status_fjcm,
         tt_incident type standard table of zdt_inct_fjcm.
