class zcl_inct_prio_ve_fjcm definition
  public
  final
  create public.
...
class zcl_inct_prio_ve_fjcm implementation.
  ...
  method if_sadl_exit_calc_element_read~calculate.
    ...
    data lt_data type standard table of z_r_incidents_fjcm with default key.
